...
bool ColorShader::Render(ID3D11DeviceContext* context, int indexCount, XMMATRIX rotationMatrix, XMMATRIX translationMatrix, XMMATRIX worldMatrix,
	XMMATRIX viewMatrix, XMMATRIX projectionMatrix)
{
	bool result;

	result = SetShaderParams(context, rotationMatrix, translationMatrix, worldMatrix, viewMatrix, projectionMatrix);
...
bool ColorShader::InitializeShader(ID3D11Device* device, HWND hWnd, LPCWSTR vsFile, LPCWSTR psFile)
{
	HRESULT result;
...
bool ColorShader::SetShaderParams(ID3D11DeviceContext* context, XMMATRIX rotationMatrix, XMMATRIX translationMatrix, XMMATRIX worldMatrix,
	XMMATRIX viewMatrix, XMMATRIX projectionMatrix)
{
	HRESULT result;
